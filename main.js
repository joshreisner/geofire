$(function(){
	...
	firebase.initializeApp({
		apiKey: 'AIzaSyAHgoUk-vzZfk0CPhkOBNsX5fTyrCKVkh8',
		databaseURL: 'https://example-b3d77.firebaseio.com'
	});

	// Create a new GeoFire instance
	var firebaseRef = firebase.database().ref('fish');
	...
	var map = new google.maps.Map($('#map').get(0), {
		center: {lat: 39.05971647403474, lng: -77.00592041015625},
		zoom: 10,
